...
// CreateOrUpdateTopology that should be applied to the Service operators Pods
func CreateOrUpdateTopology(
	ctx context.Context,
	helper *helper.Helper,
	name string,
	selectorKey string,
	...
	t := topologyv1.TopologySpec{
		TopologySpreadConstraints: &[]k8s_corev1.TopologySpreadConstraint{
			{
				...
				WhenUnsatisfiable: toUnsatisfiableConstraintAction(*instance.Spec.Topology.WhenUnsatisfiable),
			},
		},
	}
...
// toUnsatisfiableConstraintAction - a utility function to convert a string passed
// from the top-level topology interface to the UnsatisfiableConstraintAction k8s
// type, required when building a TopologySpreadConstraint object
func toUnsatisfiableConstraintAction(s string) k8s_corev1.UnsatisfiableConstraintAction {
